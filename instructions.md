...
<<<<<<< Updated upstream
    * Votre fichier [exercice.py](exercices123.py) sera automatiquement mis à jour dans GitHub et visible au professeur
=======
...
<<<<<<< Updated upstream
      pour envoyer vos modifications du fichier [exercice.py](exercices123.py) à GitHub et au professeur
=======
